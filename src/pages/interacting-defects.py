...
def layout():
    ...
    input_table = dash_table.DataTable(
        id='interacting_defects_input_table',
        columns=[
    ...
    collapse = html.Div(
        [
            dbc.Button(
                "Secondary defect",
                id="interacting_defects_secondary_defect_collapse_button",
                className="mb-3",
                color="primary",
                n_clicks=0,
            ...
            dbc.Collapse(
                [
                    dbc.Row(
                        dash_table.DataTable(
                            id='interacting_defects_secondary_input_table',
                            columns=[
                                {'name': 'Parameter', 'id': 'Parameter', 'editable': False},
                                {'name': 'Value', 'id': 'Value', 'editable': True},
                                {'name': 'Unit', 'id': 'Unit', 'editable': False}],
                    ...
                    dbc.Row(
                        dcc.DatePickerRange(
                            id='interacting_defects_date_range',
                ...
                id="interacting_defects_secondary_defect_collapse",
                is_open=False,
            ),
        ]
    )
    ...
    input_layout = dbc.Row(
        [
            ...
            dbc.Row(
                [
                    dbc.Col(dbc.InputGroup([
                        ...
                        dbc.Select(
                            id='interacting_defects_select_safety_class',
                            value='medium',
                            options=[
                                {'label': 'Low', 'value': 'low'},
            ...
            dbc.Row(
                [
                    dbc.Col(dbc.InputGroup([
                        ...
                        dbc.Select(
                            id='interacting_defects_select_measurement',
                            value='relative',
                            options=[
            ...
            dbc.Row(dbc.Col(
                [
                    dbc.Button(children='Analyse', id='interacting_defects_table_analyse',
                               style={"margin-top": "10px", "margin-bottom": "10px"}),
                    dcc.Markdown(id='interacting_defects_table_analysis')
                ]
            )),
            dbc.Modal(
                [
                    dbc.ModalHeader(dbc.ModalTitle("Input Error")),
                    dbc.ModalBody(id='interacting_defects_input_error_modal_body'),
                ],
                id="interacting_defects_input_error_modal",
                is_open=False,
            ),
        ],
    ...
    graphs_layout = dbc.Row(
        children=[
            ...
            dbc.Row(dbc.Col(dcc.Loading(dcc.Graph(id='interacting_defects_table_graph')), xs=12, md=10), justify='center'),
            dbc.Row([
                dbc.Col(dcc.Loading(dcc.Graph(id='interacting_defects_pipe_cross_section_graph')), xs=12, sm=10, md=5),
                dbc.Col(dcc.Loading(dcc.Graph(id='interacting_defects_defect_cross_section_graph')), xs=12, sm=10, md=5)
            ], justify='center'),
            dbc.Row(dbc.Col(dcc.Markdown(id='interacting_defects_table_evaluation', style={"text-align": "center"})))
        ],
        style={"margin-top": "15px", **center_align_style}
    )
    ...
    combined_layout = dbc.Container(
        children=[
            html.Div(id='display'),
            dbc.Row(html.H1("Interacting Defects Analysis"), style={"text-align": "center"}),
            input_layout,
            graphs_layout
        ],
        fluid=True
...
@callback(
    Output(component_id='interacting_defects_table_graph', component_property='figure'),
    Output(component_id='interacting_defects_pipe_cross_section_graph', component_property='figure'),
    Output(component_id='interacting_defects_defect_cross_section_graph', component_property='figure'),
    Output(component_id='interacting_defects_table_analysis', component_property='children'),
    Output(component_id='interacting_defects_table_evaluation', component_property='children'),
    Output(component_id="interacting_defects_input_error_modal", component_property="is_open"),
    Output(component_id="interacting_defects_input_error_modal_body", component_property="children"),
    Input(component_id='interacting_defects_table_analyse', component_property='n_clicks'),
    State(component_id='interacting_defects_input_table', component_property='data'),
    State(component_id='interacting_defects_select_safety_class', component_property='value'),
    State(component_id='interacting_defects_secondary_input_table', component_property='data'),
    State(component_id='interacting_defects_date_range', component_property='start_date'),
    State(component_id='interacting_defects_date_range', component_property='end_date'),
)
...
@callback(
    Output(component_id='interacting_defects_input_table', component_property='data'),
    Output(component_id='interacting_defects_secondary_input_table', component_property='data'),
    Input(component_id='interacting_defects_select_measurement', component_property='value'),
    State(component_id='interacting_defects_input_table', component_property='data'),
    State(component_id='interacting_defects_secondary_input_table', component_property='data'),
...
@callback(
    Output(component_id='interacting_defects_input_table', component_property='data', allow_duplicate=True),
    Input(component_id='interacting_defects_input_table', component_property='data_timestamp'),
    State(component_id='interacting_defects_input_table', component_property='data'),
    prevent_initial_call=True
)
