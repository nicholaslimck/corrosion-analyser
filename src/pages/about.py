...
layout = dbc.Container([
    dbc.Row(dbc.Col([
        html.H1("About This Tool", className="mt-4 mb-3"),
        dcc.Markdown(
            ...
            '"Different forms of internal corrosion in hydrocarbon pipelines")\n\n'
            ...
            "the recommended practice to simplify the assessment process."
        ),
        html.P([
