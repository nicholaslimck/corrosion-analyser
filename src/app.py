...
def example_a_2():
    ...
    pipe_config = {
        ...
        'accuracy_absolute': measurement_tolerance,
...
@callback(
    ...
    Output(component_id='evaluation', component_property='children'),
...
def update_graph(example_selected):
    ...
    description = [
        f"""Pipe Dimensions:
            Outside Diamenter:      {pipe.dimensions.outside_diameter}
